...
Run with .venv/bin/python scripts/catalog-accessory-assets.py.
...
SOURCE = ROOT / 'output/accessory-assets-2026-09-21'
PUBLIC = ROOT / 'public/assets/accessories-2026-09'
...
for spec in json.loads((SOURCE / 'prompts.json').read_text()):
    ...
    for row in range(rows):
        ...
        for col in range(cols):
            ...
            if name in ['new-crop-stages', 'duel-actions']:
