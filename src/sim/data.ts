...
export const BUILDINGS: Record<BuildingKind, BuildingDefinition> = {
  ...
  castle: { name: '青岚城堡', description: '石墙与塔楼的常备要塞，警戒半径 11 格，把强盗挡在整片城区之外。每级扩大 1 格。', category: 'services', cost: 2600, wood: 40, stone: 45, materials: { materials: 12 }, frame: null, technology: 'metallurgy', guardRadius: 11 },
  ...
  citygate: { name: '城门', description: '城墙上的门洞。城墙会挡住去路，围起来的街区要在墙上留一道门，居民与搬运工才进得来、出得去。', category: 'decoration', cost: 180, wood: 0, stone: 12, frame: null, environment: 1 },
  ...
  hunterlodge: { name: '林间猎人屋', description: '猎人带回 2 份鲜肉和 2 张皮毛。肉送肉铺，皮毛卖给远方——猎场不会枯竭，只是收成没有作坊那么稳。', category: 'production', cost: 440, wood: 14, stone: 6, frame: null, cycle: 50, output: { pelt: 2, meat: 2 }, workers: 1, autoCollect: true },
